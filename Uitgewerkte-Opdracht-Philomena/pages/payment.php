...
include "pages/lib/error_reporter.dev.php";

include "pages/vendor/autoload.php";
...
$molliePrice = number_format((float)$price,2,'.','' );
...
$payment = $mollie->payments->create([
   ...
   "redirectUrl" => 'https://localhost/Philomena%20fase%203/Uitgewerkte-Opdracht-Philomena/index.php?page=dashboard',
